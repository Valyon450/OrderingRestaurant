    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceListNotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceListNotes_Dishes_DishId",
                        column: x => x.DishId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceListNotes_DishId",
                table: "PriceListNotes",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceListNotes_Id",
                table: "PriceListNotes",
                column: "Id",
                unique: true);
        }
