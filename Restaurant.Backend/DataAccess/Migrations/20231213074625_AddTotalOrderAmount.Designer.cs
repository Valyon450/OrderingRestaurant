...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231213074625_AddTotalOrderAmount")]
    partial class AddTotalOrderAmount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.Order", b =>
                {
                    ...
                    b.Property<decimal>("TotalOrderAmount")
                        ...
                        .HasComputedColumnSql("SUM(orderItem.Quantity * pln.Price)");
            ...
            modelBuilder.Entity("DataAccess.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<Guid>("PriceListNoteId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DataAccess.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("DataAccess.Entities.PriceListNote", "PriceListNote")
                        .WithMany()
                        .HasForeignKey("PriceListNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Order");

                    b.Navigation("PriceListNote");
                });
